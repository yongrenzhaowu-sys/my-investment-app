...
# Save results
results_df.to_csv('pbr_roe_weekly_phase2_equal_weight_results.csv', index=False, encoding='utf-8-sig')
tax_log_df.to_csv('pbr_roe_weekly_phase2_equal_weight_tax_log.csv', index=False, encoding='utf-8-sig')
print()
print('週次結果をCSV保存: pbr_roe_weekly_phase2_equal_weight_results.csv')
print('税金ログをCSV保存: pbr_roe_weekly_phase2_equal_weight_tax_log.csv')
